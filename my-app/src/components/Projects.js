    ...
    return (
        <section id="projects">
            ...
            <div className="flex flex-col items-center mx-auto">
                ...
                <div className="flex flex-col md:flex-row mt-5 space-x-8 items-center">
                    <div className="items-top mb-6 md:mb-0">
                        <button className="shadow hover:shadow-2xl">
                            <img src={websitePic} className="projectPic border border-black border-2"></img>
                        </button>
                        <div className="text-xl text-center mt-4"> My Personal Website!</div>
                    </div>
                    <div className="items-top mb-6 md:mb-0">
                        <button className="shadow hover:shadow-2xl">
                            <img src={expensePic} className="projectPic border border-black border-2"></img>
                        </button>
                        <div className="text-xl text-center mt-4"> Expenses App!</div>
                    </div>
                    <div className="items-top mb-6 md:mb-0">
                        <button className="shadow hover:shadow-2xl bg-white">
                            <img src={forkPic} className="projectPic border border-black border-2"></img>
                        </button>
                        <div className="text-xl text-center mt-4"> Purdue Meal Finder App!</div>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row mt-10 items-center space-x-8">
                    <div className="items-top mb-6 md:mb-0">
                        <button className="shadow hover:shadow-2xl bg-white">
                            <img src={purduePic} className="projectPic border border-black border-2"></img>
                        </button>
                        <div className="text-xl text-center mt-4"> Quiz Management Tool!</div>
                    </div>
                    <div className="items-center mb-6 md:mb-0">
                        <button className="shadow hover:shadow-2xl bg-white">
                            <img src={matrixPic} className="projectPic border border-black border-2"></img>
                        </button>
